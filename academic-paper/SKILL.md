...
| `references/failure_paths.md` | 失敗路徑圖（12 種情境 + 處理策略） | all agents |
| `references/mode_selection_guide.md` | 8 種模式選擇指南 + 銜接路徑 | intake |
| `references/credit_authorship_guide.md` | CRediT 14 角色 + ICMJE + AI 政策 + 貢獻矩陣 | intake, formatter, draft_writer |
| `references/funding_statement_guide.md` | 台灣/國際資助格式 + 聲明範本 | intake, formatter, draft_writer |
...
| `templates/credit_statement_template.md` | Author x Role 貢獻矩陣 + CRediT 聲明產出 |
| `templates/funding_statement_template.md` | 資金來源登記 + 聲明產出 |
