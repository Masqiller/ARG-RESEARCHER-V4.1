...
These rules harden the synthesis output against the five narrative-side hallucination/drift patterns documented in `docs/design/2026-04-29-arg-v3.6.7-downstream-agent-pattern-protection-spec.md` §3.1 (A1–A5).
