...
**Status**: v1.0 (introduced ARG v3.5, 2026-04-21)
...
**Canonical location**: `shared/collaboration_depth_rubric.md` in `Masqiller/ARG-Researcher`. External consumers should reference by stable URL; do not vendor (bump the `rubric_version` field on any modification).
