...
Spec: `docs/design/2026-04-23-arg-v3.6.2-sprint-contract-design.md`.
...
2. Run `python scripts/check_sprint_contract.py <path> --arg-version vX.Y.Z`; expect
...
- `passport/audit_artifact_entry.schema.json` (v3.6.7 Step 6) — `audit_artifact[]` entries
  ...
  `docs/design/2026-04-30-arg-v3.6.7-step-6-orchestrator-hooks-spec.md` §3.1-§3.2.
...
Spec: `docs/design/2026-04-30-arg-v3.6.7-step-6-orchestrator-hooks-spec.md` §3.
