...
**Status**: v3.2
**Source**: Lu et al. (2026, Nature 651:914-919) Figure 1c — template-based mode produces higher-quality, lower-variance papers; template-free mode produces more diverse outputs but lower mean quality and higher variance. ARG maps this finding onto its own mode taxonomy.
...
ARG modes fall on a spectrum between these poles. This table is the reference for decisions about:
