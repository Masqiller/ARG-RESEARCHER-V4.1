# ARG v3.6.6 A/B Evidence Fixture

This directory holds the A/B evidence fixture for ARG v3.6.6's
generator-evaluator contract gate. The `manifest.yaml` instantiates the §6.2
schema declared in `docs/design/2026-04-27-arg-v3.6.6-generator-evaluator-contract-design.md`.
