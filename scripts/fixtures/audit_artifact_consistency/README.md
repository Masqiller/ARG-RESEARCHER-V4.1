...
Synthetic JSON / YAML / JSONL files for ARG v3.6.7 Phase 6.3 lint tests.
...
ARG repo checkout. To spot-check a fixture from the CLI, pass
...
The default `--repo-root` (the actual ARG checkout containing `.git`)
