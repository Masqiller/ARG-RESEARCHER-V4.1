#!/usr/bin/env python3
"""audit_snapshot.py — ARG v3.6.7 Step 6 Phase 6.1 byte-exact snapshot helper.
...
def render_prompt(
    ...
    rendered_intro = (
        f"# ARG v3.6.7 cross-model audit — round {round_n} of {target_rounds}\n"
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description="ARG v3.6.7 audit bundle snapshot helper. "
