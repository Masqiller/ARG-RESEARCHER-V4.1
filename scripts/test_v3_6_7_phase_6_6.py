"""Static checks for ARG v3.6.7 Step 6 Phase 6.6 — orchestrator prompt §3.5
Audit Artifact Gate subsection.

Spec: docs/design/2026-04-30-arg-v3.6.7-step-6-orchestrator-hooks-spec.md
...
#   docs/design/2026-05-12-arg-v3.7.3-claim-faithfulness-and-contaminated-source-spec.md
...
def _measure_v3_7_3_extension_block_lines(text: str) -> int:
    ...
    subtracted from the v3.6.7 Phase 6.6 +60 budget. Spec:
      docs/design/2026-05-12-arg-v3.7.3-claim-faithfulness-and-contaminated-source-spec.md §3.1+§3.2
...
class V371Step3bLineBudgetTest(unittest.TestCase):
    ...
    line cap; this test pins +40 lines as the contract for ARG prompt
