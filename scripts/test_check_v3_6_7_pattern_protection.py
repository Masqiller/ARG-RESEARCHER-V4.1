"""Unit tests for check_v3_6_7_pattern_protection.py (ARG v3.6.7 lint).
...
class _MutationTestBase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self._tmpdir = tempfile.TemporaryDirectory(prefix="arg-v367-test.")
...
class CodexR3MutationTests(_MutationTestBase):
    ...
    def test_r3_p2_inv2_intro_paragraph_disclosure_fails(self) -> None:
        ...
        _mutate(
            self._repo_dir,
            "deep-research/agents/synthesis_agent.md",
            "documented in `docs/design/2026-04-29-arg-v3.6.7-downstream-agent-pattern-protection-spec.md` §3.1 (A1–A5).",
            "documented in `docs/design/2026-04-29-arg-v3.6.7-downstream-agent-pattern-protection-spec.md` §3.1 (A1–A5). "
