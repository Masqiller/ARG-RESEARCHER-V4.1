#!/usr/bin/env python3
"""Static audit for ARG v3.6.7 downstream-agent pattern protection.

Spec: docs/design/2026-04-29-arg-v3.6.7-downstream-agent-pattern-protection-spec.md
    ...
    for segment_offset, kind, normalized in _iter_block_segments(block):
        ...
        for label, pat in INV2_PATTERNS:
            ...
            errors.append(
                ...
                f"docs/design/2026-04-30-arg-v3.6.7-step-6-orchestrator-hooks-spec.md §6.2."
            )
...
def main(argv: list[str]) -> int:
    ...
    if failed:
        ...
        print(
            "  docs/design/2026-04-29-arg-v3.6.7-downstream-agent-pattern-protection-spec.md",
            file=sys.stderr,
        )
        print(
            "  docs/design/2026-04-30-arg-v3.6.7-step-6-orchestrator-hooks-spec.md (INV-1/2/3)",
            file=sys.stderr,
        )
        return 1
