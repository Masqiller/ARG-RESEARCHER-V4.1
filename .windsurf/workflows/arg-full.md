---
description: ARG full pipeline — research → write → review → revise → finalize
---
...
1. Read the orchestrator skill entry at `academic-pipeline/SKILL.md` to understand the full pipeline stages.
