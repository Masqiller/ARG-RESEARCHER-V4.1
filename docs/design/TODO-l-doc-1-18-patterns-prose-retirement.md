...
**Why:** the v3.6.7 inventory enumerates 17 numbered pattern IDs (A1-A5, B1-B5, C1-C3, D1-D4). Earlier prose drafted before the §7.1 inventory walk used "18 patterns" as a summary count. The fixture set (17 micro + 1 integration) already tracks the 17-ID inventory; only the summary prose needs retirement. See `docs/design/2026-04-30-arg-v3.6.7-step-6-orchestrator-hooks-spec.md` §7.1 + §9.2 L-doc-1 for the off-by-one analysis.

## Eight retirement locations

### Upstream main spec — `docs/design/2026-04-29-arg-v3.6.7-downstream-agent-pattern-protection-spec.md`
...
### This spec — `docs/design/2026-04-30-arg-v3.6.7-step-6-orchestrator-hooks-spec.md`
