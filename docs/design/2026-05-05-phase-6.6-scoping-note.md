...
Spec `docs/design/2026-04-30-arg-v3.6.7-step-6-orchestrator-hooks-spec.md` carries three numbers that do not reconcile:
...
- Edit `docs/design/2026-04-30-arg-v3.6.7-step-6-orchestrator-hooks-spec.md`:
...
3. **Should `feedback_complex_spec_review_inventory_pattern.md` invariants index get amended for v3.6.7 Step 6?** That memory captures ARG v3.6.7 Step 6 as 18-round-converged. The Phase 6.6 spec drift discovered here suggests a Round 19+ cascade-sweep of §10 phase budgets vs §5.6 actual content size.
